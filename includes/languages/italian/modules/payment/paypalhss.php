 ...
 */
  ...
  define('MODULE_PAYMENT_PAYPALHSS_TEXT_DESCRIPTION', '<strong>PayPal Pro</strong> <br /><a href="https://www.paypal.com/it/cgi-bin/webscr?cmd=_login-run">Gestisci il tuo conto PayPal</a><br /><br /><font color="green">Configuration Instructions:</font><br /> <a href="https://www.paypal-business.it/paypalpro.asp">Vuoi saperne di più? - clicca qui</a><br /> <ul>' . (defined('MODULE_PAYMENT_PAYPALHSS_STATUS') ? '' : '<li>... clicca sopra su "install"per abilitare PayPal Pro ... e clicca "edit" per configurare il tuo conto PayPal su osCommerce Cart.</li>') . '</ul><font color="green"><hr /><strong>Requisiti:</strong></font><br /><hr />*<strong>Conto PayPal</strong> (<a href="https://www.paypal.com/it/cgi-bin/webscr?cmd=_registration-run">Registrati</a>)<br />*<strong>*<strong>Porta 80</strong> usata per comunucazioni bidirezionali con il gateway, pertanto deve essere lasciata aperta sul tuo router/firewall dell''host<br />*<strong>Impostazioni:</strong> devono essere configurato come descritto sopra.');
